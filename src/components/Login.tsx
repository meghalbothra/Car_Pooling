...
export function Login({ onLogin }: LoginProps) {
  ...
  try {
   ...
   localStorage.setItem("id", newEmployee.id);
    ...
    // ✅ Log just id and emp_id
    console.log("🪪 Saved to localStorage → id:", localStorage.getItem("id"));
    console.log("👤 Saved to localStorage → emp_id:", localStorage.getItem("emp_id"));
